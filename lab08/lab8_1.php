...
<body>
    ...
    //     {
    //         try {
    //             $stm = $this->pdo->query("SELECT*FORM users ORDER BY id DESC");
    //             $users = $stm->fetchAll(PDO::FETCH_ASSOC);
    //             $this->returnJson("success", "Lay danh sach nguoi dung thanh cong", $users);
    //         } catch (PDOException $e) {
    //             $this->returnJsonError("Khong the lay danh sach nguoi dung", $e->getMessage());
    //         }
    //     }
    // }
    ?>
